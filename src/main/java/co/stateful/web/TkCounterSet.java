 ...
 * @since 2.0
 */
public final class TkCounterSet implements Take {
     ...
     */
    public TkCounterSet(final Base bse, final String cnt) {
        this.base = bse;
        this.name = cnt;
    }
    ...
    public Response act(final Request req) throws IOException {
        ...
        new RqUser(req, this.base).user().counters().get(this.name)
